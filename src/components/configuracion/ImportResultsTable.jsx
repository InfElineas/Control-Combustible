                ...
                <td className="px-3 py-2">
                  <Badge
                    ...
                    className={`text-[10px] py-0 px-1.5 ${
                      item.accion === 'RECARGA' ? 'border-emerald-200 text-emerald-700'
                ...
                <td className="px-3 py-2">
                  {mode === 'results' && st ? (
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-red-600 truncate max-w-[140px]" title={item.errors.join(', ')}>{item.errors[0]}</span>
                    </div>
                  ) : hasWarning ? (
                    <div className="flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5 text-amber-500 shrink-0" />
                      <span className="text-amber-600 truncate max-w-[140px]" title={item.warnings.join(', ')}>{item.warnings[0]}</span>
                    </div>
                  ) : (
                    <div className="flex items-center gap-1">
