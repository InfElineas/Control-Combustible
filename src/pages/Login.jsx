...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // Si no hay error, Supabase redirige al proveedor OAuth automáticamente
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-sky-50">
      <div className="w-full max-w-sm mx-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Control Combustible</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-sm font-medium transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-sm"
          >
            {loading ? (
